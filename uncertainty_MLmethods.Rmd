...
xgb_crossvali =  function(n,df, y_var) {
  ...
  xgboost_LUR(df,  y_varname= y_var, training=training, test=test, grepstring =varstring,  max_depth =6, gamma=5, eta =0.007, nrounds = 3000, training=training, test=test, grepstring =varstring, xgb_lambda = 2, xgb_alpha = 0, subsample = 0.7 )
} 
...
LA_crossvali =  function(n,df, y_var) {
  ...
  VLA = data.frame(RF = rowMeans(data.frame(VLA)))
  VLA
