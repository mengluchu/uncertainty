rm(list = ls())
# changed to "adaptive, fixed spatial crossvalidation (though we in this study use non-spatial crossvalidation)
...
# Call inla()
lres = fnFitModelINLA(d, dp = dp, covnames, formula = formula, TFPOSTERIORSAMPLES = FALSE, family = "Gamma")
