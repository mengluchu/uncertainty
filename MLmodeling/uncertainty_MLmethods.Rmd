...
```{r, eval=F}
xgb_crossvali =  function(n,df, y_var,typecrossvali = "crossvalispatial") {
  smp_size = floor(0.8* nrow(df)) 
  set.seed(n)
...
```{r, eval = F}
rf_crossvali =  function(n,df, y_var,typecrossvali = "crossvalispatial") {
  smp_size <- floor(0.8 * nrow(df)) 
  set.seed(n)
  if(typecrossvali == "crossvalinotspatial"){
    training <- sample(seq_len(nrow(d)), size = smp_size)
...
```{r, eval=F}
LA_crossvali =  function(n,df, y_var,typecrossvali = "crossvalispatial") {
  smp_size <- floor(0.8 * nrow(df)) 
  set.seed(n)
  if(typecrossvali == "crossvalinotspatial"){
    training <- sample(seq_len(nrow(d)), size = smp_size)
...
```{r}
q_rf_crossvali =  function(n,df, y_var,typecrossvali = "crossvalispatial") {
  smp_size <- floor(0.8 * nrow(df)) 
  set.seed(n)
   if(typecrossvali == "crossvalinotspatial"){
    training <- sample(seq_len(nrow(d)), size = smp_size)
