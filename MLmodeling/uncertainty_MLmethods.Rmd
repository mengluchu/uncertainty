...
packages <- c( "devtools", "dplyr","data.table" , "ggplot2" , "RColorBrewer", "xgboost",  "glmnet", "ranger", "randomForest","tidyr" ,"tibble","stargazer", "sf", "CAST", "caret", "quantregForest", "pdp")
ipak(packages)
...
model_LLO = train(predic, merged3[,y_var],
                   method="rf",tuneGrid=data.frame("mtry"=34), importance=TRUE,
...
quantRF <- ranger(x = x_p[training,],
                     y = y_denl[training], mtry = 34, num.trees = 1000,
                     quantreg = T) 
